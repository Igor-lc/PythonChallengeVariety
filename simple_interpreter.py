...
'''
Благодаря этому коду наш интерпретатор может складывать два числа. Просто запустите программу и введите два числа с плюсом и без пробела между ними! Чтобы количество чисел было произвольным нужно доработать код.
